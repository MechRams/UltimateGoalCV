...
public class RingPipeline extends OpenCvPipeline {
	...
	public Mat processFrame(Mat input) {
		...
		//PASO 3: Convertir el espacio del color del Mat de RGB A HSV
		...
		CVGripUtils.cvErode(hsvBlurredThreshMat, erodeKernel, erodeAnchor, erodeIterations, erodeBordertype, erodeBordervalue, erodeMat);
		...
		CVGripUtils.cvFindContours(hsvThreshMat, false, contours);
